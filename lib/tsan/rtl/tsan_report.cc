...
//Vector<ReportMop*>* chkStack = new Vector<ReportMop*>(MBlockReportMop);
...
const char *thread_name(char *buf, int tid) {
  ...
  //type of data race to be reported
...
static const char *const kInterposedFunctionPrefix = "__interceptor_";
  ...
  //where the error occured (this gets called for printing the stack)
...
static void PrintMutexSet(Vector<ReportMopMutex> const& mset) {
  ...
  //memory operation description (blue) d.Access()
...
/* *** Change (added an overloaded function) *** */
void ReportDesc::PrintReport(const ReportDesc *rep, Vector<ReportStack *>* stackChk) {
  ReportDesc::PrintReport(rep);
}

/* *** Change (added an overloaded function) *** */
void ReportDesc::PrintReport(const ReportDesc *rep, Vector<ReportStack *>* stackChk,
  SymbolizedStack **leafChk) {
    ReportDesc::PrintReport(rep);
}


void ReportDesc::PrintReport(const ReportDesc *rep, Vector<ReportLocation*>* locationChk) {
  ReportDesc::PrintReport(rep);
}

Vector<ReportMop*>*  ReportDesc::PrintReport(const ReportDesc *rep, 
...
/* Check on the following three (reduction)*/
