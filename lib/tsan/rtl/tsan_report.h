...
class ReportDesc {
 public:
  ...
  //reduction on stack trace
  static void PrintReport(const ReportDesc *rep, 
    Vector<ReportStack*>* stackChk);
  //reduction on location (stack of main thread, heap, etc)
  static void PrintReport(const ReportDesc *rep, 
    Vector<ReportLocation*>* locationChk);
  //reduction on basis of leaf point of execution
  static void PrintReport(const ReportDesc *rep, 
    Vector<ReportStack*>* stackChk, 
